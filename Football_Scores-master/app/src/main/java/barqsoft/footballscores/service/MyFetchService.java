        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                ...
                if (isReal || League.equals(PREMIER_LEGAUE) ||
                    ...
                    SimpleDateFormat match_date = new SimpleDateFormat(getString(R.string.date_format)
                            + getString(R.string.time_full_format), Locale.getDefault());
                    match_date.setTimeZone(TimeZone.getTimeZone("UTC"));
                    try {
                        Date parseddate = match_date.parse(mDate + mTime);
                        SimpleDateFormat new_date = new SimpleDateFormat(getString(R.string.date_format)
                                + ":" + getString(R.string.time_simple_format), Locale.getDefault());
                        ...
                        if (!isReal) {
                            ...
                            SimpleDateFormat mformat = new SimpleDateFormat(getString(R.string.date_format), Locale.getDefault());
